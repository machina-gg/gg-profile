  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#0a0a12]">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-[#F472B6] rounded-full blur-[200px] opacity-10 animate-pulse-slow"
          style={{ animationDelay: '1s' }}
        />
        <div
          className="absolute top-1/2 right-1/3 w-[400px] h-[400px] bg-[#67E8F9] rounded-full blur-[200px] opacity-5 animate-pulse-slow"
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <Image
          ...
          width={35}
          height={35}
          className="absolute top-[15%] right-[20%] opacity-60 animate-sparkle"
        ...
        <Image
          ...
          width={30}
          height={30}
          className="absolute top-[25%] left-[8%] opacity-50 animate-sparkle"
          style={{ animationDelay: '1s' }}
        />
        <Image
          src="/assets/decorations/sparkle-2.svg"
          ...
          width={45}
          height={45}
          className="absolute top-[20%] right-[10%] opacity-65 animate-sparkle"
        ...
        <Image
          ...
          width={25}
          height={25}
          className="absolute top-[35%] left-[25%] opacity-55 animate-sparkle"
          style={{ animationDelay: '2s' }}
        />
        <Image
          src="/assets/decorations/sparkle-2.svg"
          ...
          width={38}
          height={38}
          className="absolute top-[40%] right-[30%] opacity-60 animate-sparkle"
        ...
        <Image
          ...
          width={20}
          height={20}
          className="absolute top-[18%] right-[35%] opacity-45 animate-twinkle"
        ...
        <Image
          ...
          width={18}
          height={18}
          className="absolute top-[30%] left-[5%] opacity-40 animate-twinkle"
        ...
        <Image
          ...
          width={22}
          height={22}
          className="absolute top-[22%] right-[5%] opacity-50 animate-twinkle"
        ...
        <Image
          ...
          width={16}
          height={16}
          className="absolute top-[45%] left-[12%] opacity-35 animate-twinkle"
        ...
        <Image
          ...
          width={20}
          height={20}
          className="absolute top-[38%] right-[15%] opacity-45 animate-twinkle"
        ...
        <Image
          ...
          width={32}
          height={32}
          className="absolute bottom-[35%] left-[20%] opacity-50 animate-sparkle"
        ...
        <Image
          ...
          width={28}
          height={28}
          className="absolute bottom-[40%] right-[25%] opacity-55 animate-sparkle"
        ...
        <Image
          ...
          width={18}
          height={18}
          className="absolute bottom-[30%] left-[35%] opacity-40 animate-twinkle"
        ...
        <Image
          ...
          width={22}
          height={22}
          className="absolute bottom-[45%] right-[8%] opacity-45 animate-twinkle"
          style={{ animationDelay: '2s' }}
        />
        ...
        <Image
          ...
          width={16}
          height={16}
          className="absolute top-[50%] right-[22%] opacity-35 animate-float"
          style={{ animationDelay: '-1s' }}
        />

        {/* Gaming decorations - subtle */}
        <Image
          src="/assets/decorations/gamepad.svg"
          alt=""
          width={50}
          height={50}
        ...
        />
        <Image
          src="/assets/decorations/keyboard.svg"
          alt=""
          width={45}
          height={45}
        ...
        />
        <Image
          src="/assets/decorations/headset.svg"
          alt=""
          width={48}
          height={48}
          className="absolute bottom-[35%] left-[3%] opacity-10 animate-float"
          style={{ animationDelay: '-2s' }}
        />
      </div>
        ...
        <div className="flex justify-center mb-8">
          <div className="relative">
            ...
            <Image
              ...
              width={20}
              height={20}
              className="absolute -top-2 -right-5 opacity-70 animate-sparkle"
              style={{ animationDelay: '0.5s' }}
            />
            <Image
        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-6 md:gap-10 mb-12">
            <div className="text-center relative">
              ...
              />
              <div className="text-2xl md:text-3xl font-black text-[#FDE68A] drop-shadow-[0_0_10px_rgba(253,230,138,0.5)]">
                FREE
              </div>
            ...
            <div className="text-center relative">
              ...
              />
              <div className="text-2xl md:text-3xl font-black text-[#F472B6] drop-shadow-[0_0_10px_rgba(244,114,182,0.5)]">
                3秒
              </div>
            ...
            <div className="text-center relative">
              <Image
                ...
                width={14}
                height={14}
                className="absolute -top-2 -left-2 opacity-60 animate-twinkle"
                style={{ animationDelay: '0.5s' }}
              />
              <div className="text-2xl md:text-3xl font-black text-[#67E8F9] drop-shadow-[0_0_10px_rgba(103,232,249,0.5)]">
                SNS
              </div>
        ...
        <div className="relative flex justify-center mt-4">
          <div className="relative">
            ...
            <Image
              ...
              width={32}
              height={32}
              className="absolute -top-4 right-[25%] opacity-65 animate-sparkle z-10"
              style={{ animationDelay: '0.7s' }}
            />
            <Image
              src="/assets/decorations/star-1.svg"
              ...
              width={24}
              height={24}
              className="absolute top-[10%] -left-4 opacity-55 animate-twinkle z-10"
              style={{ animationDelay: '0.3s' }}
            />
            <Image
              src="/assets/decorations/star-2.svg"
              ...
              width={22}
              height={22}
              className="absolute top-[15%] -right-2 opacity-50 animate-twinkle z-10"
              style={{ animationDelay: '1s' }}
            />
